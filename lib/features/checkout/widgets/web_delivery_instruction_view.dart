    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          // boxShadow: [BoxShadow(color: Theme.of(context).primaryColor.withAlpha((0.05 * 255).toInt()), blurRadius: 10)],
        ...
        child: GetBuilder<CheckoutController>(builder: (checkoutController) {
          return Column(
              ...
              children: [
                ...
                //           child: Container(
                //             decoration: BoxDecoration(
                //               color: isSelected ? Theme.of(context).primaryColor.withAlpha((0.5 * 255).toInt()) : Colors.grey[200],
                //               borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
