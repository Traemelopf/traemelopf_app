...
//             color: businessController.businessIndex == index ? Theme.of(context).primaryColor.withAlpha((0.05 * 255).toInt()) : Theme.of(context).cardColor,
...
//                 : Theme.of(context).disabledColor.withAlpha((0.5 * 255).toInt()), width: 0.5) : null,
...
//               child: Text(title, style: robotoMedium.copyWith(color: businessController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt()), fontSize: Dimensions.fontSizeDefault,
...
//               color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt())), textAlign: TextAlign.justify, textScaler: const TextScaler.linear(1.1),
//             ) : const SizedBox(),
//
//           ]),
//         ),
