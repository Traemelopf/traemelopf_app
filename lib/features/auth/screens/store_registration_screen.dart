                                                                    ...
                                                                    child: storeRegController.pickedLogo !=
                                                                        ...
                                                                        : SizedBox(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              Icon(CupertinoIcons.photo_camera_solid, size: 30, color: Theme.of(context).disabledColor.withAlpha((0.6 * 255).toInt())),
                                                                              const SizedBox(height: Dimensions.paddingSizeSmall),
                                                                              Padding(
                                                                                padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                                                                                child: Text(
                                                                                  'upload_store_logo'.tr,
                                                                                  style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt())),
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          Icon(
                                                                              ...
                                                                              size: 30,
                                                                              color: Theme.of(context).disabledColor.withAlpha((0.6 * 255).toInt())),
                                                                          Text(
                                                                            'upload_store_cover'.tr,
                                                                            style:
                                                                                robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt())),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                          ),
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: robotoRegular.copyWith(color: Theme.of(context).disabledColor.withAlpha((0.6 * 255).toInt()), fontSize: Dimensions.fontSizeSmall),
                                                                              textAlign: TextAlign.center,
                                                                            ),
                                                                          ),
                                                                        ]),
      ...
      return Container(
        ...
        child: CustomButton(
          ...
          buttonText: storeRegController.storeStatus == 0.1 &&
              ...
              ? 'next'.tr
              : 'submit'.tr,
          color: /*ResponsiveHelper.isDesktop(context) ? Theme.of(context).disabledColor.withAlpha((0.9 * 255).toInt()) :*/
